...
import { A4_WIDTH, A4_HEIGHT, LOGO_BASE64_CLEAN, DEFAULT_HEADER_COLOR, DEFAULT_STROKE_COLOR, DEFAULT_STROKE_WIDTH, HEADER_HEIGHT } from './constants';
import { addTextZone } from './utils/canvasUtils';

// Patch global de la fonction focus pour éviter le scroll intempestif de Chromium 
// lors de l'édition de texte dans un conteneur utilisant transform: scale()
...
const App: React.FC = () => {
  ...
  const [zoom, setZoom] = useState(0.5); // 50% par défaut car la base est plus grande (150 DPI)
      ...
      <div className="flex-1 bg-gray-300 overflow-auto p-12 relative scroll-smooth">
         <div className="flex flex-col items-center gap-12 pb-32">
            {pages.map((page, index) => {
                ...
                const canvasHeight = isPageOne ? A4_HEIGHT - HEADER_HEIGHT : A4_HEIGHT;
